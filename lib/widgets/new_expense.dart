...
class _NewExpenseState extends State<NewExpense>{
 ...
 void _submitExpenseData(){
  ...
  final  amountIsInvalid = enteredAmount == null || enteredAmount<=0; //amount invalid is true when it is null or less than zero
   if (_titleController.text.trim().isEmpty || amountIsInvalid || _selectedDate == null ){
    showDialog(context: context, builder: (ctx) => AlertDialog(
      title:const  Text('invalid input'),
      content: const Text('please make sure valid title,amount,category was entered.'),
      actions: [
            ...
            children: [
             ...
             Expanded(
                child:Row(
                    ...
                    children: [Text(_selectedDate ==null ? 'No Date Selected':formatter.format(_selectedDate!)),
